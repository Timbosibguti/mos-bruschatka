...
$roistatData = isset($_POST['roistat_data']) ? $_POST['roistat_data'] : '[]';
$name = $roistatData['firstname'];
$email = $roistatData['email'];
$phone = $roistatData['telephone'];

$info = '';
// $info .= add_data('ID Заявки', $our_order_id);
$info .= add_data('', $roistatData);
