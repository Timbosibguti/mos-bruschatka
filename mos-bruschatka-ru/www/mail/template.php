...
if(!$json['error']) {
	$title = $json['data']['title'] ? $json['data']['title'] : '';
	...
	$roistatData = array(
		...
		'key'     => 'MTU5NzY6MTE3Mzk1OmQzYzBiNzhhNTBjMWE3ZTMwMGI1YzFkYmI3MWU2NWVk', // Ключ для интеграции с CRM, указывается в настройках интеграции с CRM.
