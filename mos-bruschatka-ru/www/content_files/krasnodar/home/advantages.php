    ...
    <div class="container container--constraint">
        ...
        <div class="row no-gutters">
            ...
            <div class="advantages__col">
                ...
                <p class="advantages__text">В нашем каталоге 500+ моделей тротуарной плитки. Все, что нужно для создания идеального ландшафта, вы найдете в одном месте - существенная экономия вашего времени. Информативная интернет-площадка поможет в выборе нужного товара и оплате счета.</p>
