...
<div class="section about" id="about">
	<div class="container container--constraint">
		<div class="row">
			<div class="col-md-5">
				<h2 class="whitespace-nowrap">КраснодарБрусчатка</h2>
				<h3 class="about__sub-title">крупнейший магазин<br />тротуарной плитки<br />в Краснодаре</h3>
				<ul class="about__list">
					...
					<li class="about__list-item">
						...
						<p><span class="text--yellow text--bold">шоу-рум</span> в центре Краснодара </p>
					</li>
					<li class="about__list-item">
					...
					<li class="about__list-item">
						...
						<p><span class="text--yellow text--bold">современное производство</span> на 2500 м<sup>2</sup>/сутки</p>
					</li>
					<li class="about__list-item">
					...
					<li class="about__list-item">
						...
						<p><span class="text--yellow text--bold">8 точек отгрузки</span> и самовывоза по Краснодару</p>
					</li>
				</ul>
			</div>
			<div class="col-md-7">
