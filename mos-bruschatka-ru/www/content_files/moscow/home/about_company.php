...
<div class="section about" id="about">
	<div class="container container--constraint">
		<div class="row">
			<div class="col-md-5">
				<h2 class="whitespace-nowrap">МосБрусчатка</h2>
				<h3 class="about__sub-title">крупнейший магазин<br />тротуарной плитки<br />в Москве</h3>
				<ul class="about__list">
					...
					<li class="about__list-item">
						...
						<p><span class="text--yellow text--bold">шоу-рум</span> в центре Москвы </p>
					</li>
					<li class="about__list-item">
					...
					<li class="about__list-item">
						...
						<p><span class="text--yellow text--bold">собственный завод</span> на 3500 м<sup>2</sup>/сутки</p>
					</li>
					<li class="about__list-item">
					...
					<li class="about__list-item">
						...
						<p><span class="text--yellow text--bold">50 000 м <sup>2</sup> плитки</span> в наличии, 2500 моделей</p>
					</li>
					<li class="about__list-item">
						<div class="svg-border svg-border--50 icon-house-big about__icon-block"></div>
						<p><span class="text--yellow text--bold">15 точек отгрузки</span> и самовывоза по Москве</p>
					</li>
				</ul>
			</div>
			<div class="col-md-7">
