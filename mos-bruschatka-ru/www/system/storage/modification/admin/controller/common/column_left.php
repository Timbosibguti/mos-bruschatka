...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			if ($this->user->hasPermission('access', 'custom/pages')) {
				$custom[] = array(
					'name'	   => $this->language->get('text_pages'),
					'href'     => $this->url->link('custom/pages', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
      ...
      // OCFilter start
		  ...
		  // OCFilter end
			...
			// if ($this->user->hasPermission('access', 'catalog/custom_pages')) {		
			// 	$catalog[] = array(
			// 		'name'	   => $this->language->get('text_custom_pages'),
			// 		'href'     => $this->url->link('catalog/custom_pages', 'token=' . $this->session->data['token'], true),
			// 		'children' => array()		
			// 	);					
			// }
...
// lightshop			
			if ($this->user->hasPermission('access', 'catalog/lightshop_news')) {		
				$catalog[] = array(
					'name'	   => $this->language->get('text_lightshop_news'),
					'href'     => $this->url->link('catalog/lightshop_news', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);					
			}
			$blog = array();
			
			if ($this->user->hasPermission('access', 'catalog/lightshop_blog')) {
				$blog[] = array(
					'name'     => $this->language->get('text_lightshop_blog'),
					'href'     => $this->url->link('catalog/lightshop_blog', 'token=' . $this->session->data['token'], true),
					'children' => array()	
				);
			}
			
			if ($this->user->hasPermission('access', 'catalog/lightshopcat_blog')) {
				$blog[] = array(
					'name'	   => $this->language->get('text_lightshopcat_blog'),
					'href'     => $this->url->link('catalog/lightshopcat_blog', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			if ($this->user->hasPermission('access', 'catalog/lightshopblog_review')) {
				$blog[] = array(
					'name'	   => $this->language->get('text_lightshopblog_review'),
					'href'     => $this->url->link('catalog/lightshopblog_review', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
...
// lightshop
			...
			if ($this->user->hasPermission('access', 'catalog/subscribe')) {
				$sale[] = array(
					'name'	   => $this->language->get('text_subscribe'),
					'href'     => $this->url->link('catalog/subscribe', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
// lightshop end
