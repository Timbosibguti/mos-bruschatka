...
<!-- lightshop -->		
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <label class="radio-inline"><input type="radio" name="filter_grouptype" value="0" <?php echo $filter_grouptype == '0' ? 'checked' : '' ?>> И </label>
                <label class="radio-inline"><input type="radio" name="filter_grouptype" value="1" <?php echo $filter_grouptype == '1' ? 'checked' : '' ?>> ИЛИ </label>
              </div>  
            </div>  
<!-- lightshop end -->
