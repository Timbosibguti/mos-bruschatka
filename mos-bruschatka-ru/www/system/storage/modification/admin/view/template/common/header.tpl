...
<!-- lightshop -->		
		...
		<li class="divider"></li>
			<li class="dropdown-header">Лайтшоп</li>
			<li><a href="<?php echo $callbacks; ?>"><span class="label label-warning pull-right"><?php echo $callbacksNewCount; ?></span>Обратный звонок</a></li>
			<li><a href="<?php echo $comments; ?>"><span class="label label-warning pull-right"><?php echo $commentNewCount; ?></span>Отзывы блога</a></li>
