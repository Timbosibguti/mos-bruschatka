			...
			<div class="col-sm-10">
			 <ul class="nav nav-tabs" id="language">
			  ...
			  <div class="tab-content">
				...
				<textarea id="input-description<?php echo $language['language_id']; ?>" name="option_description[<?php echo $language['language_id']; ?>][description]" class="form-control summernote"><?php echo isset($option_description[$language['language_id']]['description']) ? $option_description[$language['language_id']]['description'] : ''; ?></textarea>
				</div>
				<?php } ?>
			  </div>
			</div>
