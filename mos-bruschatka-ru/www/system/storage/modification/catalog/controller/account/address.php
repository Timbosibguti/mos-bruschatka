...
//lightshop start
		...
		$activeFields = $this->model_catalog_lightshop->getFields($this->config->get('config_customer_group_id'),0);
...
//lightshop start				
		...
		$ignoredFields = $this->model_catalog_lightshop->getIgnoredFields($this->config->get('config_customer_group_id'),0);
