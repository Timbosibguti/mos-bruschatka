...
//lightshop start
		...
		$activeFields = $this->model_catalog_lightshop->getFields($this->session->data['guest']['customer_group_id']);
...
//lightshop start				
		...
		$json['error'] = $this->model_catalog_lightshop->checkLCustomFields($json['error']);
		$ignoredFields = $this->model_catalog_lightshop->getIgnoredFields($this->session->data['guest']['customer_group_id']);
		if(isset($json['error'])){
