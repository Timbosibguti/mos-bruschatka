					...
					<div class="form-group">
						...
						<div class="col-sm-10">
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
							<a href="" id="thumb-min_img" data-toggle="image" class="img-thumbnail"><img src="<?php echo $min_img; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
							<input type="hidden" name="img" value="<?php echo $img; ?>" id="input-min_img" />
							</div>
						  </div>
							<div class="form-group required">
							  <label class="col-sm-3 control-label" for="input-image-related">Размер изображения</label> 
							  <div class="col-sm-9">
								<div class="row">
								  <div class="col-sm-4">
