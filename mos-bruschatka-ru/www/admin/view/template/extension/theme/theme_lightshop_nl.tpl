						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="input-group">
									...
									<button  id="sendkey" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
									</div>
								</div>
							</div>
						</div>	
...
$(document).ready(function() {
	$('#sendkey').on('click', function(e) {
		...
		var data = $('#key').val();
		$.ajax({
			url: 'index.php?route=extension/theme/theme_lightshop/activatekey&token=<?php echo $token; ?>&newkey=1',
			type: 'post',
			dataType: 'json',
