...
function addDiscount() {
    ...
    <?php } ?>
    html += '  </select></td>';
    html += '  <td class="text-right"><input type="text" name="product_discount[' + discount_row + '][quantity]" value="10" placeholder="<?php echo $entry_quantity; ?>" class="form-control" /></td>';
