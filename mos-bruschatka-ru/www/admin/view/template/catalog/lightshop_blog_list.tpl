            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                 ...
                 <td class="text-left" class="text-center" style="width: 130px;"><?php echo $column_image; ?></td> 
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($blog['blog_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
				<td class="text-center"><img src="<?php echo $blog['image']; ?>" alt="" title="" class="img-thumbnail" style="width: 50px;"></td> 
