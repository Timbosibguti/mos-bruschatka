...
class ModelCatalogLightshopcatblog extends Model {
	public function addCategoryBlog($data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "url_alias WHERE query = 'lightshopcatblog_id=" . (int)$category_id . "'");

		if (isset($data['keyword'])) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "url_alias SET query = 'lightshopcatblog_id=" . (int)$category_id . "', keyword = '" . $this->db->escape($data['keyword']) . "'");
		}
