...
class ControllerSaleCallback extends Controller { 
	private $error = array();
  	...
  	private function getList() {
		...
		$results = $this->model_sale_callback->getCallbacks($dataF);
		...
		$this->response->setOutput($this->load->view('sale/callback_list', $data));				
  	...
  	private function getForm() {
		...
		$this->response->setOutput($this->load->view('sale/callback_form', $data));
