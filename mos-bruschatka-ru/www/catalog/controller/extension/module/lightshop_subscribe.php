...
class ControllerExtensionModuleLightShopSubscribe extends Controller {
	...
	public function addsubscribe() {
		...
		$this->load->model('catalog/lightshopsubscribe');
		...
		} elseif ($this->model_catalog_lightshopsubscribe->checkEmail($email_subscriber)) {
		...
		if (!$json ) {
			...
			$this->model_catalog_lightshopsubscribe->addSubscribe($dataF);
			...
			$text_mail = $this->model_catalog_lightshopsubscribe->getEmailDescription((int) $this->config->get('config_language_id'));
