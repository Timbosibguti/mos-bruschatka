...
class ControllerExtensionModuleLightshopNews extends Controller {
	...
	public function getnews() {
		...
		$news_info = $this->model_catalog_lightshopnews->getNews($news_id);
		...
		if ($news_info) {
			...
			$results = $this->model_catalog_lightshopnews->getProductRelated($this->request->get['news_id']);
	...
	public function getnewslist() { 
		...
		$totalNews = $this->model_catalog_lightshopnews->getNewssTotal();
