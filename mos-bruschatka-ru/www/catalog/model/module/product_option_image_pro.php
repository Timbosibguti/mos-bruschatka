...
class ModelModuleProductOptionImagePro extends Model {
  ...
  private function theme_config_get($setting_name) {
	...
	public function getDataForProductPage($results=array(), $poip_sizes=array()) {
		...
		} elseif ( isset($this->request->get['quickview_id']) ) {
			$poip_product_id = $this->request->get['quickview_id'];
  ...
  public function getCategoryImages($product_id, $module_setting=false, $return_ordered=false) { // $return_ordered currently not used
    ...
    if ($this->getThemeName() == "pav_fashion" && (!$module_setting || $module_setting=="related_products") ) {
      ...
      $icon_width = 40;
      $icon_height = 40;
		} elseif ( $this->getThemeName() == "dalia" ) {
      $icon_width = 40;
      $icon_height = 40;
		} elseif ( $this->getThemeName() == "techone" ) {
      $icon_width = 40;
      $icon_height = 40;		
		// Pavilion (BurnEngine)
