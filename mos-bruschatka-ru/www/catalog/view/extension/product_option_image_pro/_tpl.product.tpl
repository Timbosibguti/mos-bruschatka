<script type="text/javascript"><!--
	...
	//poip_product_custom.prototype.additional_startOfEventAdditionalImageMouseover = function(image_a) {
	//	var this_object = this;
	//	
	//}
	...
	//poip_product_custom.prototype.if_setProductOptionValue = function(value, $option_element) {
	//	var this_object = this;
	//	
	//	return true;
	//}
	...
	//poip_product_custom.prototype.if_eventMainAImgClick = function(e, element) {
	//	var this_object = this;
	//}
