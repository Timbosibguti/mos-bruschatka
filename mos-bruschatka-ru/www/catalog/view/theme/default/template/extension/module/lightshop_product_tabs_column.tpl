	...
	<?php if(empty($products[$tab])){ continue; } ?>
				...
				<?php foreach ($products[$tab] as $key => $product) { ?>
						<li class="catalogue__product-list-item card-highlight">		
						...
						<?php } ?>
							<div class="products-list__caption">
								<div class="row">
								<div class="col-7"><a href="<?php echo $product['href']; ?>" class="text--color-1 products-list__name js-catalog-products-list-name"><span><?php echo $product['name']; ?></span></a></div>
