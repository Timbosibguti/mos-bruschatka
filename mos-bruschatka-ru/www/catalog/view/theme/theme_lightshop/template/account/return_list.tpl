				...
				<table class="table">
					<thead>
						<tr class="table__row table__row--hover">
							<td class="table__col table__col--right"><?php echo $column_return_id; ?></td>
					...
					<tbody>
						...
						<tr class="table__row table__row--hover">
							<td class="table__col table__col--right"><?php echo $return['return_id']; ?></td>
							<td class="table__col"><?php echo $return['status']; ?></td>
							<td class="table__col"><?php echo $return['date_added']; ?></td>
							<td class="table__col table__col--right"><?php echo $return['order_id']; ?></td>
							<td class="table__col"><?php echo $return['name']; ?></td>
							<td class="table__col table__col--right"><a href="<?php echo $return['href']; ?>" title="<?php echo $button_view; ?>" class="btn"><?php echo $button_view; ?></a></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>
