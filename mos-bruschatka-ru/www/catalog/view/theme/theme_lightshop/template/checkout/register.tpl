	...
	<div class="checkout__input-row">
		...
		<?php foreach ($allCustomFields as $fieldName) { ?>
			<div <?php echo !${'entry_'.$fieldName.'_show'} ? 'style="display:none"' : ''; ?> class="checkout__input-box form-group">
				...
				<?php } else { ?>				
					<input type="text" name="<?php echo $fieldName; ?>" value="" placeholder="<?php echo ${'entry_'.$fieldName}; ?>" id="input-payment-<?php echo str_replace('_','-',$fieldName); ?>">
				<?php } ?>
			</div>	
		<?php } ?>
		...
		<div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="checkout__textarea-box form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
			<span class="checkout__input-box-title"><?php echo $custom_field['name']; ?></span>
			<textarea name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" placeholder="<?php echo $custom_field['name']; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" ><?php echo $custom_field['value']; ?></textarea>
		</div>	
		<?php } ?>
		...
		<div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="checkout__input-box form-group custom-field " data-sort="<?php echo $custom_field['sort_order']; ?>">
			<span class="checkout__input-box-title"><?php echo $custom_field['name']; ?></span>
			<input type="text" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" data-date-format="YYYY-MM-DD" placeholder="<?php echo $custom_field['name']; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="date">
		</div>	
		<?php } ?>
		<?php if ($custom_field['type'] == 'time') { ?>
		<div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="checkout__input-box form-group custom-field " data-sort="<?php echo $custom_field['sort_order']; ?>">
			<span class="checkout__input-box-title"><?php echo $custom_field['name']; ?></span>
			<input type="text" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" data-date-format="HH:mm" placeholder="<?php echo $custom_field['name']; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="time">
		</div>	
		<?php } ?>
		<?php if ($custom_field['type'] == 'datetime') { ?>
		<div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="checkout__input-box form-group custom-field " data-sort="<?php echo $custom_field['sort_order']; ?>">
			<span class="checkout__input-box-title"><?php echo $custom_field['name']; ?></span>
			<input type="text" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" data-date-format="YYYY-MM-DD HH:mm" placeholder="<?php echo $custom_field['name']; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="datetime">
		</div>	
		<?php } ?>
		<?php } ?>
		<?php } ?>	
...
<div id="address">	
	...
	<div class="checkout__radio-row">
		<div class="checkout__checkbox-box-row form-group">
			<div class="checkout__radio-item">
				<input name="newsletter" id="newsletter-1" type="checkbox" value="1">
				<label for="newsletter-1"><?php echo $entry_newsletter; ?></label>
			</div>		
		</div>	
	</div>	
	...
	<div class="checkout__checkbox" <?php echo $checkout_st3_sa ? 'style="display: none;"' : '' ?>>
			<div class="checkout__checkbox-box-row">
				<div class="checkout__checkbox-item">
					<input name="shipping_address" id="shipping_address" type="checkbox" value="1" checked="checked">
	...
	<div class="checkout__button-box">
		<a href="#" class="btn btn--empty" id="button-register-b"><?php echo $button_back; ?></a>
		<button type="button" class="btn btn--transparent" id="button-register"><?php echo $button_continue; ?><svg class="icon-arrow-long-right"><use xlink:href="#arrow-long-right"></use></svg></button>
	</div>	
<script>
ocDateTimepicker();
