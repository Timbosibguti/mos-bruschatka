	...
	<div class="checkout__radio">
			<div class="checkout__radio-box-row">
				<div class="checkout__radio-item">
					...
					<label for="payment_address-existing"><?php echo $text_address_existing; ?></label>
				</div>	
			</div>	
	</div>	
	...
	<div class="checkout__radio">
			<div class="checkout__radio-box-row">
				<div class="checkout__radio-item">
					...
					<label for="payment_address-new"><?php echo $text_address_new; ?></label>
				</div>	
			</div>	
	</div>
	<?php } ?>
...
<div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
	...
	<div class="checkout__button-box">
		<button type="button" class="btn btn--transparent" id="button-payment-address"><?php echo $button_continue; ?><svg class="icon-arrow-long-right"><use xlink:href="#arrow-long-right"></use></svg></button>
	</div>	
</form>
<script>
ocDateTimepicker();
